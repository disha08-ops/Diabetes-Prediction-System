...
Original file is located at
    https://colab.research.google.com/drive/15XE8wpJ4n0wgVNsANLXjbWw9R4bmYeWq
...
diabetes_dataset = pd.read_csv('~/Desktop/MY CODE/Diabetes Prediction Model/diabetes.csv')
